...
from api import orb_api, orb_resource, orb_resource_url, ORBAPIResourceExistsException
from error_codes import *

INFILE = os.path.join(BASE_DIR, 'ghmp_data', 'GHMP-ORB-data.csv')
...
MPOWERING_DEFAULT_TAGS = ["Global health Media Project",
                          "Video",
                          "Laptop",
                          "Smartphone",
                          "Tablet",
        ...
        for counter, row in enumerate(file_reader):
            ...
            for lang in LANGUAGES:
                if row[CSV_FORMAT[lang]].strip() != "":
                    ...
                    resource_url.title = "View/Download on Global Health Media website ("+ lang +")"
